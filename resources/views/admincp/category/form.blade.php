        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row" style="color: white">
                        <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Đường Dẫn Danh Mục</label>
                    ...
                    <div class="form-group row" style="color: white">
                        <label for="exampleInputMobile" class="col-sm-3 col-form-label">Mô Tả Danh Mục</label>
                        <div class="col-sm-9">
                            {!! Form::textarea('description', isset($category) ? $category->description : '', ['class' => 'ckeditor form-control', 'placeholder' => 'Nhập vào mô tả danh mục...', 'style' => 'resize: none; width: 100%;', 'id' => 'description']) !!}
                        </div>
                    </div>
                    <div class="form-group row" style="color: white">
                        <label for="exampleInputPassword2" class="col-sm-3 col-form-label">Tình Trạng Danh Mục</label>
                        <div class="col-sm-9">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content" style="background-color: #191c24; color: white">
                                ...
                                <div class="modal-footer">
                                    ...
                                    {!! Form::submit(isset($category) ? 'Cập Nhật' : 'Thêm Mới', ['class' => 'btn btn-danger']) !!}
                                </div>
                            </div>
                        </div>
                    </div>
