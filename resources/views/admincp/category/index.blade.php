<x-app-layout>
    <x-slot name="header">
        ...
        <a href="{{ route('category.create') }}" class="btn btn-light" style="margin-top: 30px">Thêm Mới Danh Mục
            Phim</a>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8"
            ...
            <div class="bg-gray-100 dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="text-gray-900 dark:text-gray-100">
                    <table class="table table-responsive text-gray-900 dark:text-gray-100" id="tableDanhMucPhim">
                        <thead>
                        <tr>
                            <th scope="col">#</th>
