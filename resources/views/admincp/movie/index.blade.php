...
@section('content')
    <div class="content-wrapper">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Liệt Kê Danh Sách Phim</h4>
                        ...
                        <table class="table table-striped" id="tablePhim">
                            ...
                            @foreach($list as $key => $movie)
                                <tr>
                                    ...
                                    {{--Hình Ảnh--}}
                                    <td style="width: 100%;">
                                        <img style="width: 150px; height: 250px; "
                                    ...
                                    <td class="col-md-6 mb-3"
                                        style="max-width: 100%; white-space:pre-wrap; word-wrap:break-word">{{$movie->description}}</td>
