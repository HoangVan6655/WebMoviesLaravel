<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-max mx-auto sm:px-6 lg:px-8" style="background-color: rgb(17 24 39 / var(--tw-bg-opacity)); color: black">
                    ...
                    <table class="table text-gray-900 dark:text-gray-100" id="tablePhim">
                        ...
                        @foreach($list as $key => $movie)
                            <tr>
                                ...
                                {{--Quản Lý Phim--}}
                                <td>
                                    <button id="deleteBtn" type="button" class="btn btn-danger" onclick="showModal('{{ $movie->id }}')">
                                        Xoá
                                    </button>
